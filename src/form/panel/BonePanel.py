...
BONE_PAIRS = {
    "Root": {
        ...
        "rigidBody": None,
        "rigidbodyMode": 0,
        "rigidbodyFactor": None,
        "rigidbodyCollisions": -1,
    ...
    "J_Bip_C_Hips": {
        ...
        "rigidbodyMode": 0,
        "rigidbodyFactor": None,
        "rigidbodyCollisions": 0,
        "rigidbodyNoCollisions": [0, 1, 2],
        "rigidbodyParam": [1, 0.5, 0.5, 0, 0.5],
    },
    "J_Bip_C_Spine": {
        "name": "下半身",
        "parent": "腰",
...
RIGIDBODY_PAIRS = {
    "髪": {
        "rigidbodySubdivision": 1,
        "rigidBody": 2,
        "rigidbodyFactor": 1,
        "rigidbodyCoefficient": 2,
        "rigidbodyCollisions": 3,
        "rigidbodyNoCollisions": [3],
        "rigidbodyParamFrom": [1, 0.7, 0.7, 0, 0],
        "rigidbodyParamTo": [0.1, 0.999, 0.999, 0, 0],
        "JointTLMin": [0, 0, 0],
        "JointTLMax": [0, 0, 0],
        "JointRLMin": [-80, -5, -80],
        "JointRLMax": [80, 5, 10],
    ...
    "Sleeve": {
        ...
        "rigidbodyFactor": 1,
        "rigidbodyCoefficient": 2,
        "rigidbodyCollisions": 4,
        "rigidbodyNoCollisions": [1, 4],
        "rigidbodyParamFrom": [2, 0.9, 0.9, 0, 0.5],
        "rigidbodyParamTo": [0.5, 0.9999, 0.9999, 0, 0.5],
        "JointTLMin": [0, 0, 0],
        "JointTLMax": [0, 0, 0],
        "JointRLMin": [-15, -2, -25],
        "JointRLMax": [135, 2, 25],
    ...
    "Others": {
        ...
        "rigidbodyFactor": 1,
        "rigidbodyCoefficient": 2,
        "rigidbodyCollisions": 9,
        "rigidbodyNoCollisions": [9],
        "rigidbodyParamFrom": [2, 0.9, 0.9, 0, 0.5],
        "rigidbodyParamTo": [0.5, 0.9999, 0.9999, 0, 0.5],
        "JointTLMin": [0, 0, 0],
        "JointTLMax": [0, 0, 0],
    ...
    "胸先": {
        ...
        "JointRLMin": [0, 0, 0],
        "JointRLMax": [0, 0, 0],
        "JointSCT": [100000, 100000, 100000],
        "JointSCR": [100000, 100000, 100000],
    },
    "横": {
        "JointTLMin": [0, 0, 0],
        "JointTLMax": [0, 0, 0],
